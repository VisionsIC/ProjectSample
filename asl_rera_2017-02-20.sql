...
# Database: asl_rera
# Generation Time: 2017-02-20 06:38:15 +0000
# ************************************************************
...
INSERT INTO `users` (`id`, `username`, `firstname`, `lastname`, `title`, `email`, `password`, `remember_token`, `created_at`, `updated_at`)
VALUES
	(1,'wilsaa','Aaron','Wilson','Patient Care Technician','asl.rera.sample@gmail.com','$2y$10$tKw05cJBFJD2D5D.QWA8G.6c139EgE25Mp4Wu34aVhXP5R7Lf6Z6O','gJwdPosqXbuMhG73XUjGzgm5FsonmI6mWSSbQlgygaRTPqgrJb7OgVGPqOVI','2016-12-02 05:44:45','2017-02-10 18:29:32'),
	(2,'StardomOne','Bob','Rogers','Therapist','bobr@mlhs.org','$2y$10$LD7cl7bzwoxDGDq2ekoyCe/kOv85QaebcKhYFx6GQ/hckqtM.5QfW','n0KzAoynrnBnffdIgVY94JpNziF0I9JxzbZ27j2yoIqK31Iuu6SnFfljOlmK','2016-12-02 15:30:43','2016-12-02 15:31:55'),
	(3,'DominicBoy','Dominic','Wilson','Son of PCT','wilsdo@mlhs.org','$2y$10$n.9icRzNKuE9unaRBBnvUeIfX0s3Y9Q/nIInFYDUnjqoQHZ0FwR4S','fzuqjpX1Mgvf7A5CBefNNMSiEWtdKrSa6TlCiQEu00uUjK1qsglZLyCv7XzH','2016-12-11 01:04:24','2016-12-11 01:06:18'),
	(4,'JoeCool','Joe','Cool','Stud','studman@studville.com','$2y$10$tN9Hmo3A4um2hhGko74xlenkq1ucZAF0BpdTTZ8EgJHifg4BtRCLG','L9j86LxFg6thBNbzmZ0qU97bLGnzX0pKc5ky02AD5Mj7cqNSydtQ3dbLmMRN','2017-01-13 06:50:43','2017-01-13 06:50:55'),
	(5,'Fido','Fred','Baggins','Dreamer','fbaggins@dreams.com','$2y$10$7iAUrPjo77Uy.2E3eRj7kOotI3YuserJUJ06dqSmQnuFuoqqiWr3u','nAGT0VvFgcZT4X2dXWifawvr53p63KcyG3BFYUqGDplYIA0kTl5Hj3Bg4sUJ','2017-01-13 18:23:39','2017-01-13 18:23:58'),
	(6,'JoeLogin','Joe','Login','Tester','loginj@tester.com','$2y$10$Jp87HVySOj4My1mE/p7tv.b1X3wpPr..7pcu1zwVRfKpGY97eR1NW','iHnJzAoIcxD0UY6SlfYHgYoHCJ0Dl9yyBxgapxp3gqPXN1utBZnEOiFntdsY','2017-02-10 17:36:34','2017-02-10 17:37:01'),
	(7,'TestPersonOne','Test','Person','Tester','persont@tester.com','$2y$10$HIWGFFdz2Sswg4DZMsLVHe0L3lTdB8j1m8znlgygVCoZunUvJhkeO','KelNXcZ4TeggXGnWbKGHzr9zByg2Es41fV0H36Y22hCzsqX9iARyvdnSTrPT','2017-02-10 18:05:04','2017-02-10 18:05:27');
